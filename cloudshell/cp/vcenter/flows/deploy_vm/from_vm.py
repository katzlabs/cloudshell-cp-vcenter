...
class VCenterDeployVMFromVMFlow(AbstractVCenterDeployVMFromTemplateFlow):
    def _get_vm_template(self, deploy_app: VMFromVMDeployApp, dc):
    ...
    def _prepare_vm_details_data(self, deployed_vm, deploy_app: VMFromVMDeployApp):
        ...
        return vm_details_actions.prepare_vm_from_vm_details(
